...
save.onclick = function menu () {
    ...
    if (document.querySelector('#list').style.display === 'block') {
        ...
        document.querySelector('#menu').style.animation = 'disappear .2s linear';
        document.querySelector('#list').style.animation = 'disappear .2s linear';
        document.querySelector('#notice').style.display = 'block';
    } else {
        document.querySelector('#list').style.display = 'block';
        document.querySelector('#menu').style.backgroundColor = 'rgb(231, 231, 231)';
        document.querySelector('#menu').style.animation = 'spread .2s linear';
        document.querySelector('#list').style.animation = 'spread .2s linear';
